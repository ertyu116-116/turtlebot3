...
class turtlebot_move():
    def __init__(self):
        rospy.init_node('turtlebot_move', anonymous=False) #make a 'turtlebot_move node'
        rospy.loginfo("Press CTRL + C to terminate") 
        rospy.on_shutdown(self.stop) #if i press CTRL + C , It will be terminated
        ...
        self.vel = Twist() #msg type is (linear,angular)
